...
hotelsNum = [item.text for item in d.find_elements_by_css_selector(
    "h1[class='sorth1']")]
...
hotelAddress = [item.text for item in d.find_elements_by_css_selector(
    '.wrap-hotelpage-top [class="address address_clean"]')]
print(hotelAddress)

reviewCount = [item.text for item in d.find_elements_by_css_selector(
    '.bui-pagination__controls [class="bui-pagination__info"]')]
print(reviewCount)
print(int(reviewCount[0].split('–')[1]))

reviewCount = d.find_elements_by_css_selector(
    '.bui-pagination__controls [class="bui-pagination__info"]')
print(reviewCount[0].text)
print(int(reviewCount[0].text.split('–')[1]))
